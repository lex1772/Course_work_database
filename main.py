...
def main():
    ...
    while flag:
        ...
        if user_num > 5:
            ...
            method_dict[user_num]()

        user_input = input(
            "Вы хотите продолжить? Наберите 'да' для продолжения или что-угодно для завершения программы: ")
